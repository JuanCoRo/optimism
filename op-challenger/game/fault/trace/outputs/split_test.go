...
func attackTopLeafGIndex8(_ *testing.T, gameBuilder *test.GameBuilder) (ref types.Claim, pos types.Position, expectPre types.Claim, expectPost types.Claim) {
	...
	// TODO: Work out exactly what this means - probably need to use the genesis block output root?
	// No pre-claim as the first output root is being challenged. The absolute prestate should be used.
